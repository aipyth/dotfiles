...
-- local font_name = "Apple Color Emoji"
...
return {
  ...
  ssh_domains = {
    -- 159.89.18.4	lipinki
    -- 68.183.71.170	francuzkiy2
    -- 104.248.19.51	schastlyviy
    -- 164.90.235.222	francuzkiy
    -- 161.35.291.11 	sofievskiy1
    -- 207.154.224.157 slavutych
    -- 165.227.174.229	sbu
    -- 206.81.19.228	petrovsk
    -- 167.99.250.185	uyutniy
    -- 165.227.140.231	campus
    {
      name = 'li1.bot-ohrana.com',
      remote_address = '159.89.18.4',
      username = 'padik',
    },
  },
  ...
  unix_domains = {
    {
      name = 'unix',
      socket_path = "/home/john/.local/share/wezterm/sock",
