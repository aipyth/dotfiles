...
_G.packer_plugins = {
  ...
  ["FixCursorHold.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/FixCursorHold.nvim",
  ...
  ["alpha-nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  colorschemes = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/colorschemes",
    url = "https://github.com/lunarvim/colorschemes"
  },
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
    url = "https://github.com/lunarvim/darkplus.nvim"
  },
  ["friendly-snippets"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/friendly-snippets",
  ...
  ["nord-vim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/nord-vim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["nvim-transparent"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/nvim-transparent",
  ...
  ["nvim-ts-context-commentstring"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/nvim-ts-context-commentstring",
  ...
  onehalf = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/onehalf",
  ...
  ["presence.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/presence.nvim",
  ...
  ["telescope-media-files.nvim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/telescope-media-files.nvim",
  ...
  ["tex-conceal.vim"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/tex-conceal.vim",
    url = "https://github.com/KeitaNakamura/tex-conceal.vim"
  },
  ultisnips = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/ultisnips",
    url = "https://github.com/SirVer/ultisnips"
  },
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/vim-bbye",
    url = "https://github.com/moll/vim-bbye"
  },
  vimtex = {
    loaded = true,
    path = "/home/john/.local/share/nvim/site/pack/packer/start/vimtex",
